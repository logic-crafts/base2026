...
## 2026-07-17 — Phase 0 Base2026 P1 immutable preview complete; production unchanged

**Current gate: LOCAL PREVIEW PASS; PRODUCTION NO-GO.** Exact preview `base2026-phase0-p1-r6-preview-20260717-235500`, ZIP SHA-256 `6ad17478944ffb14883b117dc4579b3c5099ad03fbf15ddec5760ee9ffd87087`, was derived without corpus re-export from immutable R6 ZIP SHA-256 `9e4d7277900649dd35a39d47838989ee8eaefe9b71a0b8d23731b3d39227eed3`. Both public dataset-manifest mirrors and the relative page manifest validate with `issue_count=0`; all 18 package JSON artifacts pass the machine-local/private-storage path scan. Sitemap write and check-only both pass at exactly 1,734 URLs: 1,493 normal Source Detail + 241 frozen non-source; 199 archive/noindex and 135 future/private routes are excluded. The earlier `230500` artifact is superseded. Package schema is v4 and the hotfix path now requires the immutable candidate and closure receipt. Production, Meilisearch, IndexNow, WordPress, corpus data, forms, Git and public routing were not mutated. Canonical packet: `docs/project-memory/BASE2026_PHASE0_P1_PREVIEW_2026_07_17.md`.

Full local suite is `115/115`; exact ZIP PlanOnly preflight, PowerShell parsing, deterministic repeat derivation, ZIP integrity, diff check and publication-boundary audit all pass. Next exact action: complete independent source review, then bind any accepted code diff to this exact artifact or derive a new reviewed artifact. Do not deploy or treat the frozen 241-route static cohort as owner approval. The older 4,264-row inventory is advisory only because it contains seven stale indexable entries.
