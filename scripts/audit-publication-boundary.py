...
PUBLIC_SAFE_EXACT = {
    ...
    "scripts/derive-base2026-phase0-p1-preview.py",
    "scripts/validate-base2026-knowledge-stitch-v1.py",
    "tests/test_whole_corpus_stitch_v1.py",
    ...
    "scripts/base2026_ui_system.py",
    "scripts/base2026-search-v1-browser-gate.mjs",
    "scripts/derive-base2026-search-v1-release.py",
    "scripts/derive-base2026-search-solutions-release.py",
    "tests/test_search_v1_release.py",
    ...
    "scripts/invoke-source-detail-v2-live-gate.ps1",
    "scripts/source-detail-v2-browser-gate.mjs",
    "scripts/source-detail-v2-contract-gate.py",
    ...
    "scripts/validate-source-detail-v2-release-package.py",
    ...
    "scripts/refresh-source-detail-route-inventory.py",
    ...
    "scripts/sync-alex-root-sitemap-contract.py",
    ...
    "scripts/validate-public-manifests.py",
    ...
    "tests/test_base2026_interior_v1.py",
    "tests/test_base2026_slice1_foundation.py",
    ...
    "tests/test_derive_base2026_phase0_p1_preview.py",
    "tests/test_generate_base2026_sitemap.py",
    "tests/test_package_public_hotfix_contract.py",
    "tests/test_public_manifest_contract.py",
    "tests/test_source_detail_v2_contract_gate.py",
    "tests/test_alex_root_sitemap_contract.py",
    ...
    "tests/test_visual_reset_creator_family.py",
    "tests/test_visual_reset_family_style_closure.py",
    "web/ARCHITECTURE.md",
