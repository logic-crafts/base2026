...
PUBLIC_SAFE_EXACT = {
    ".gitattributes",
    "static/assets/founder-editorial-20260906/alex-yarosh-cobalt-portrait.webp",
    "static/assets/founder-editorial-20260906/aster-films-home.webp",
    "static/assets/founder-editorial-20260906/dreamwood-portfolio.webp",
    # Reviewed product experience and licensed authored Factory3D release.
    "packages/factory3d/.gitignore",
    "packages/factory3d/README.md",
    "packages/factory3d/assets/LICENSES.md",
    "packages/factory3d/assets/asset-provenance.json",
    "packages/factory3d/assets/glb/Textures/colormap.png",
    "packages/factory3d/assets/glb/Textures/texture-a.png",
    "packages/factory3d/assets/glb/Textures/texture-b.png",
    "packages/factory3d/index.html",
    "packages/factory3d/package-lock.json",
    "packages/factory3d/package.json",
    "packages/factory3d/public/assets/kenney/Textures/colormap.png",
    "packages/factory3d/public/assets/kenney/Textures/texture-a.png",
    "packages/factory3d/public/assets/kenney/Textures/texture-b.png",
    "packages/factory3d/public/assets/kenney/character-inspector.glb",
    "packages/factory3d/public/assets/kenney/character-worker.glb",
    "packages/factory3d/public/assets/kenney/factory-conveyor-long.glb",
    "packages/factory3d/public/assets/kenney/factory-floor-large.glb",
    "packages/factory3d/public/assets/kenney/factory-machine.glb",
    "packages/factory3d/public/assets/kenney/factory-scanner-low.glb",
    "packages/factory3d/public/assets/kenney/factory-screen-wide.glb",
    "packages/factory3d/public/assets/kenney/factory-structure-doorway-wide.glb",
    "packages/factory3d/public/assets/kenney/factory-structure-wall.glb",
    "packages/factory3d/public/licenses/kenney-blocky-characters.txt",
    "packages/factory3d/public/licenses/kenney-factory-kit.txt",
    "packages/factory3d/public/licenses/three-MIT.txt",
    "packages/factory3d/public/licenses/vite-MIT.txt",
    "packages/factory3d/public/static/brand/b26-seal.webp",
    "packages/factory3d/src/data.ts",
    "packages/factory3d/src/main.ts",
    "packages/factory3d/src/navigation.ts",
    "packages/factory3d/src/public.ts",
    "packages/factory3d/src/styles.css",
    "packages/factory3d/src/vite-env.d.ts",
    "packages/factory3d/tests/asset-integrity.test.ts",
    "packages/factory3d/tests/navigation.test.ts",
    "packages/factory3d/tsconfig.json",
    "templates/assets/factory3d/assets/index-_dIXbGJ4.css",
    "templates/assets/factory3d/assets/index-zNYj3I9L.js",
    "templates/assets/factory3d/assets/kenney/Textures/colormap.png",
    "templates/assets/factory3d/assets/kenney/Textures/texture-a.png",
    "templates/assets/factory3d/assets/kenney/Textures/texture-b.png",
    "templates/assets/factory3d/assets/kenney/character-inspector.glb",
    "templates/assets/factory3d/assets/kenney/character-worker.glb",
    "templates/assets/factory3d/assets/kenney/factory-conveyor-long.glb",
    "templates/assets/factory3d/assets/kenney/factory-floor-large.glb",
    "templates/assets/factory3d/assets/kenney/factory-machine.glb",
    "templates/assets/factory3d/assets/kenney/factory-scanner-low.glb",
    "templates/assets/factory3d/assets/kenney/factory-screen-wide.glb",
    "templates/assets/factory3d/assets/kenney/factory-structure-doorway-wide.glb",
    "templates/assets/factory3d/assets/kenney/factory-structure-wall.glb",
    "templates/assets/factory3d/factory-release.json",
    "templates/assets/factory3d/index.html",
    "templates/assets/factory3d/licenses/kenney-blocky-characters.txt",
    "templates/assets/factory3d/licenses/kenney-factory-kit.txt",
    "templates/assets/factory3d/licenses/three-MIT.txt",
    "templates/assets/factory3d/licenses/vite-MIT.txt",
    "templates/assets/factory3d/static/brand/b26-seal.webp",
    "tests/base2026_source_lab_motion.test.js",
    "tests/test_base2026_factory_release.py",
    "tests/test_base2026_investor_experience.py",
    ...
    "data/base2026_evidence_map_canary.json",
    ...
    "scripts/export-public-claim-receipts.py",
    "scripts/fetch-tiktok-avatars.py",
    "scripts/generate-base2026-sitemap.py",
    "scripts/generate-evidence-map-canary.py",
    "scripts/check-evidence-map-canary.py",
    ...
    "scripts/validate-base2026-reliability.py",
    ...
    "tests/fixtures/member-ui-preview.mjs",
    "web/ARCHITECTURE.md",
